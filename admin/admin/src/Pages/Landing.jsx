    ...
    <div>
      <div className="h-[100vh]  flex items-start justify-center  ">
        <div className="h-full w-full relative">
            ...
            <div className="bg-[#121212] w-full">
              <div className="flex w-full justify-between  items-center">
                ...
                <div className="flex p-4 space-x-2">
                  ...
                  <button
                    type="button"
                    className="text-[#1E1E1E] bg-[#3085FE] hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800"
                  >
          ...
          <div className="bg-[#121212] h-fit">
            <img
              className="-z-10 -translate-x-20 translate-y-20"
              src={pattern}
              alt=""
            />
            ...
            <div className=" pt-0  pb-8 flex justify-between   -translate-y-10 w-full ">
              <div className="w-[50vw] p-10">
                <div className=" font-bold text-[#3085FE] text-left text-5xl">
          ...
          <div className="bg-[#121212] p-1 w-full">
          ...
          <div>
            <div className="bg-[#121212] w-full text-white p-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col space-y-4 items-start">
                  ...
                  <button
                    href="#"
                    className="flex w-48 h-14 bg-black text-white border border-white rounded-xl items-center justify-center"
                  >
                    <div className="mr-3">
                  ...
                  <button
                    type="button"
                    className="flex items-center justify-center w-48 text-black bg-white rounded-lg h-14"
                  >
                    <div className="mr-3">
